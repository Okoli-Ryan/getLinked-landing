				...
				<div className="div">
					...
					<div className="py-8 px-4 border-[1px] border-primary flex flex-col gap-4 rounded-[5px] mt-8">
						<p className="font-montserrat text-center text-sm leading-[26px] md:text-base md:text-left">
							At getlinked tech Hackathon 1.0, we value your privacy and are committed to protecting your personal information. This Privacy
							Policy outlines how we collect, use, disclose, and safeguard your data when you participate in our tech hackathon event. By
